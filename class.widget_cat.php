<?php
	...
	class multi_faq_widgets_cat extends WP_Widget {

	public function __construct() {
		// widget actual processes
		
		parent::__construct(
			'faq_widget_cat', // Base ID
			'Aspire Smart FAQ Widget: Categories', // Name
			array( 'description' => __( 'Aspire Smart FAQ Widget for CATEGORIES', 'text_domain' ), ) // Args
		);
	}
	/**
	 ...
	 */
 	...
 	public function form( $instance ) {
		...
		?>
		<p>
		<label for="<?php echo $this->get_field_name( 'title' ); ?>"><?php _e( 'Category(s):' ); ?></label> 
